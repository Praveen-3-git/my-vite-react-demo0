...
export default function MiniDrawer() {
  ...
  const [content,setcontent]=React.useState(<Land/>)
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      <CssBaseline />
      <AppBar position="fixed" open={open} style={{backgroundColor:'#494949' ,color:"blanchedalmond"}}>
        <Toolbar>
          <IconButton
            color="inherit"
          ...
          <Button onClick={()=>handleclick('Land')}> <h6 style={{margin:"0", color:"blanchedalmond"}}>Student Mark Registration</h6> </Button>
          </Typography>
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3 }} className='bac'>
        <DrawerHeader />
        {content}
      </Box>
    </Box>
